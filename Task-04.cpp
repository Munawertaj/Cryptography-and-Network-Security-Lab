...
int main()
{
    ...
    string doubleCypher =  plainTextToCypherText(cypher, width);

    string originalText = cypherTextToPlainText(doubleCypher, width);
    originalText = cypherTextToPlainText(originalText, width);

    cout << doubleCypher << endl;
